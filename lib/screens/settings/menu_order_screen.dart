...
const List<MenuItemInfo> kMenuItems = [
  ...
  MenuItemInfo('services', 'Service Bill', Icons.build_rounded),
  ...
  MenuItemInfo('second_hand', 'Mobile Sales', Icons.phone_iphone_rounded),
  MenuItemInfo('laptop_sales', 'Laptop Sales', Icons.laptop_rounded),
