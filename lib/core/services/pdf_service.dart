...
/// 7-point return / repair policy note printed on the Service Job Card.
const List<String> _termsNote = [
      '1. பழுது பார்க்க கொடுத்த செல்போன் மற்றும் லேப்டாப்கள் 90 நாட்களுக்குள் திரும்ப பெறவில்லை எனில், கால போக்கின் காரணமாக திரும்ப பழுதடைந்தாலோ அல்லது தொலைந்துவிட்டாலோ நிர்வாகம் பொறுப்பில்லை.',
      '2. வாரண்டி இல்லாத பொருட்களுக்கு எந்தவித உத்திரவாதமும் இல்லை.',
      '3. கொடுத்த பொருட்களை திரும்ப பெற வரும்பொழுது பில் கட்டாயம் எடுத்து வரவேண்டும்.',
      '4. பழுது நீக்கம் செய்த பின்னர் அனைத்தையும் பரிசோதித்து எடுத்துச் செல்லவும் - இது உங்களின் பொறுப்பு.',
      '5. பரிசோதனை கட்டணம் (Inspection Fee): மொபைலைச் சரி செய்யாமல் நீங்கள் திரும்பப் பெற்றாலும், அதைப் பிரித்துப் பரிசோதித்ததற்கான குறைந்தபட்சக் கட்டணம் ரூ.50 செலுத்த வேண்டும்.',
      '6. வாரண்டி செல்லாது: சர்வீஸ் செய்த பிறகு மொபைல் மீண்டும் கீழே விழுந்தாலோ அல்லது தண்ணீரில் நனைந்தாலோ வாரண்டி செல்லாது.',
      '7. கூடுதல் பழுதுகள்: மொபைலைத் திறந்து பார்க்கும் போது, நீங்கள் சொன்னதைத் தவிர வேறு ஏதேனும் பழுது இருந்தால், அதற்குத் தனியாகக் கட்டணம் வசூலிக்கப்படும்.',
    ];
...
class PdfService {
      ...
      /// Boxed, numbered Tamil terms & conditions note - same visual style as
      /// the other sections so it lines up neatly on the A5 sheet.
      pw.Widget _termsBox() {
              return pw.Container(
                        width: double.infinity,
                        padding: const pw.EdgeInsets.all(5),
                        ...
                        child: pw.Column(
                                    ...
                                    children: [
                                                  ...
                                                  for (final line in _termsNote)
                                                    pw.Padding(
                                                                      padding: const pw.EdgeInsets.only(bottom: 1.8),
                                                                      child: pw.Text(line, style: const pw.TextStyle(fontSize: 6.3)),
                                                                    ),
                                                ],
                                  ),
                      );
